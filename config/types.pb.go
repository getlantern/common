...
func (x *BypassRequest) GetConfig() *ProxyConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
var file_config_types_proto_rawDesc = []byte{
	...
	0x22, 0x35, 0x0a, 0x0d, 0x42, 0x79, 0x70, 0x61, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x24, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0c, 0x2e, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x28, 0x0a, 0x0e, 0x42, 0x79, 0x70, 0x61, 0x73,
	...
	0x67, 0x65, 0x74, 0x6c, 0x61, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
...
var file_config_types_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_config_types_proto_goTypes = []interface{}{
	...
	(*ProxyConfig_ProxyLocation)(nil), // 3: ProxyConfig.ProxyLocation
	nil,                               // 4: ProxyConfig.PluggableTransportSettingsEntry
	nil,                               // 5: ProxyConfig.MultiplexedSettingsEntry
}
var file_config_types_proto_depIdxs = []int32{
	4, // 0: ProxyConfig.pluggable_transport_settings:type_name -> ProxyConfig.PluggableTransportSettingsEntry
	3, // 1: ProxyConfig.location:type_name -> ProxyConfig.ProxyLocation
	5, // 2: ProxyConfig.multiplexed_settings:type_name -> ProxyConfig.MultiplexedSettingsEntry
	0, // 3: BypassRequest.config:type_name -> ProxyConfig
