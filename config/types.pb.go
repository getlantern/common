...
type ProxyConfig struct {
	...
	//
	// If prefixes is not empty, the connection will multipath
	// over all prefixes. That means if you have 10 prefixes, 10
	// connections will launch and the fastest successful connection
	// will be used and the rest will be discarded (or logged if a callback is
	// specified).
	// Example prefix: `62756e6e79666f6f666f6f`
	//
	// Easy way to make a string into a hex string:
	//
	//	$ echo -n "bunnyfoofoo" | xxd -p
	Prefixes []string `protobuf:"bytes,26,rep,name=prefixes,proto3" json:"prefixes,omitempty"`
}
...
func (x *ProxyConfig) GetPrefixes() []string {
	if x != nil {
		return x.Prefixes
	}
	return nil
...
var file_config_types_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x0c, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x43, 0x6f,
	...
	0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x65, 0x73, 0x18, 0x1a, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08,
	0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x65, 0x73, 0x1a, 0x9a, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f,
